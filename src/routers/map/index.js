...
import {Map, Marker, NavigationControl, MarkerList} from 'react-bmap'
...
class MapDemo extends Component {
    render() {
        return (
            <div>
                <p styleName = 'appText'>地图演示</p>
                <Map center={{lng: 116.402544, lat: 39.928216}} zoom="11" mapStyle = {{width:'200px',height:'200px'}}>
                    <Marker
...
export default CSSModules(MapDemo, styles);